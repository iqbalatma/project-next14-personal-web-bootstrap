...
// The `$().dataTable()` method adds a `.apiService()` method to the object
// to allow access to the DataTables API
interface JQueryDataTables extends JQuery {
    /**
     * Returns DataTables API instance
     * Usage:
     * $( selector ).dataTable().apiService();
     */
    api(): Api<any>;
}
...
declare global {
    ...
    interface JQuery {
         ...
         * with an `apiService()` method which can be used to access the
         * DataTables API.
         * @param opts Configuration settings
         */
...
export interface Api<T> {
     ...
     *
     * @param index Page at which to start modifying the Api instance's result set.
