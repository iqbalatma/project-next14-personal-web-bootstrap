...
export interface LegendItem {
  ...
  /**
   * Page of the associated dataset
   */
  datasetIndex?: number;

  /**
   * Page the associated label in the labels array
   */
  index?: number
...
export interface TooltipItem<TType extends ChartType> {
  ...
  /**
   * Page of the dataset the item comes from
   */
  datasetIndex: number;

  /**
   * Page of this data item in the dataset
   */
  dataIndex: number;
