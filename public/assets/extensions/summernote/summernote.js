...
var TableResultAction = function TableResultAction(startPoint, where, action, domTable) {
   ...
   *
   * @param {int} rowIndex Page position in line of virtual table.
   * @param {int} cellIndex Page position in column of virtual table.
   ...
   *
   * @param {int} rowIndex Page of row to find free space.
   * @param {int} cellIndex Page of cell to find free space in table.
   */
