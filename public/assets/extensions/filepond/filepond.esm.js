...
const spring =
    ...
    ({ stiffness = 0.5, damping = 0.75, mass = 10 } = {}) =>
        // method definition
        {
            ...
            // need 'apiService' to call onupdate callback
...
// add to state,
// add getters and setters to internal and external apiService (if not set)
// setup animators
...
const animations = ({ mixinConfig, viewProps, viewInternalAPI, viewExternalAPI }) => {
    ...
    // expose internal write apiService
    return {
        write: ts => {
...
// add to external apiService and link to props
...
const createServerAPI = outline => {
    ...
    // remove generic headers from apiService object
    delete api.headers;
...
const defaultOptions = {
    ...
    // The server apiService end points to use for uploading (see docs)
...
const createApp = (initialOptions = {}) => {
    ...
    const exports = {
        ...
        // inject private apiService methods
        ...readWriteApi,
        ...
        /**
         * Returns all files (wrapped in public apiService)
         */
        getFiles,
    ...
    // create actual apiService object
